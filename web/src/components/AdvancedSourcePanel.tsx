  ...
  return (
    <Card className="flex h-full flex-col bg-white text-slate-900 backdrop-blur-xl shadow-xl border-slate-300/70">
      ...
      <CardContent className="flex flex-1 flex-col overflow-hidden">
        <form onSubmit={onSubmit} className="high-contrast-form-labels flex min-h-0 flex-1 flex-col gap-6">
          <div className="min-h-0 flex-1 space-y-6 overflow-y-auto pr-2">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="min-h-[260px] text-base bg-white text-slate-900 border-slate-300 placeholder:text-slate-500"
              />
